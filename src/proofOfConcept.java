...
public class proofOfConcept {
    ...
    public static void main(String[] args) {
        ...
        out.println("Removed " + pair.key() + " with quantity " + pair.value());
        out.println(
                "Total items after removal: " + playerInventory.totalItems());

        out.println();

        out.println("Is this inventory empty? " + playerInventory.isEmpty());
        ...
        out.println(
                "Unique items in inventory: " + playerInventory.uniqueItems());

        out.println();

        out.println(
                "Amount of Material A: " + playerInventory.value("Material A"));
